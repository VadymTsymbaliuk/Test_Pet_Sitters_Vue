<template>
  <div class="wrapper_form-inline">
    <form class="form-inline">
      ...
      <button type="submit" class="btn_Search btn btn-primary mb-2">
        <svg
          width="24"
          height="25"
          viewBox="0 0 24 25"
        ...
        >
          ...
          <defs>
            ...
            >
              <use
                xlink:href="#image0_48_48"
                transform="translate(-0.0146028) scale(0.00201017)"
              />
            </pattern>
            <image
              id="image0_48_48"
